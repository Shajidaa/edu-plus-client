...
const Earnings = () => {
      ...
      <div className="flex items-center justify-center min-h-screen">
        ...
        >
          <span className="text-error">
            Error loading earnings. Please try again later.
          </span>
        </div>
      </div>
    );
  ...
  const totalEarnings = payTutorData.reduce(
          ...
          >
            <div className="overflow-x-auto">
              <table className="table">
                ...
                {/* Table Body */}
                <tbody>
                  {payTutorData.map((payment, index) => (
                    <tr
